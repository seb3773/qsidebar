...
**qsidebar** is a lightweight and efficient desktop utility for Linux, written in pure C using the GTK3 toolkit.  It provides a feature-rich sidebar that emulates the functionality of the Windows 10 notification center.  
